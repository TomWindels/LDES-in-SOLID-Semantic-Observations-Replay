...
import org.lib.ldests.rdf.toStore
import org.lib.ldests.solid.SolidPublisher
import org.lib.ldests.util.keys
...
fun PublisherConfig.toPublisher(): Publisher? {
    return when (type) {
        ...
        PublisherType.Debug -> org.lib.ldests.core.DebugPublisher()
    } ?: run {
